...
<!--  </div>-->
  <div class="flex flex-col justify-center items-center w-full">
      ...
      <div class="px-4 bg-accent flex-grow">
        <div class="p-12">
          <div class="section ">
            ...
            <div class="mt-4 mb-4 font-semibold">计算机顾问</div>
            <div class="mt-10 mb-4">这是一段文本</div>
          </div>
        </div>
      </div>
    ...
    <div class="bg-base-100 text-base-content flex flex-col  items-center py-4 lg:w-3/4">
      ...
      <div class="px-5 mb-5 pb-3">2</div>
        <div class="flex justify-center items-center flex-wrap flex-grow w-full my-8">
