...
<!--         <div class="flex bg-base-200 justify-center text-base-content items-center py-4 border-t space-x-4 mt-4">-->
<!--           <a href=""><div class="font-mono text-sm">@计算机义诊</div></a>-->
...
<!--           </a>-->
<!--           <a href="">-->
<!--             @email : <span class="block">kurami.noya@gmail.com</span>-->
<!--           </a>-->
<!--         </div>-->
       </template>
       <script lang="ts">
